...
class WebViewCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "win.aiX.app", category: "WebView")
...
struct WebViewWrapper: NSViewRepresentable {
    ...
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "win.aiX.app", category: "WebView")
