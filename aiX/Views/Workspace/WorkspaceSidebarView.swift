...
struct SupportSheet: View {
    ...
    private let contactOptions: [ContactOption] = [
        ContactOption(title: "aiX", subtitle: "@aix", icon: "", iconImage: nil, iconText: "𝕏", color: .primary, url: "https://x.com/aix"),
        ...
        ContactOption(title: "GitHub", subtitle: "Report Issue", icon: "exclamationmark.triangle.fill", iconImage: nil, iconText: nil, color: .red, url: "https://github.com/vivy-company/aiX/issues")
    ]
